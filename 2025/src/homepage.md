...
在新的数据集中, 顶点数没有发生变化, 但是 PE 事件数有所增加, 为此, 我们将分数映射函数调整为如下函数:

$$
\text{score}(x) = \begin{cases}
40 \ \exp[(x + 17500) / 1000] \ , & x < -17500 \\
(x + 17500) / 100 + 40 \ , & -17500 \le x < -13500 \\
(x + 13500) / 50 + 80 \ , & -13500 \le x < -13000 \\
100 - 10 \exp[- (x + 13000) / 100] \ , & x \ge -13000
\end{cases}
$$
